...
[![Go Report Card](https://goreportcard.com/badge/omolle.com/fnd/server)](https://goreportcard.com/report/omolle.com/fnd/server)
...
1. To use Twisk as a starting point of a real project whose package name is something like `github.com/author/project`, move the directory `$GOPATH/omolle.com/fnd/server` to `$GOPATH/github.com/author/project` and do a global replacement of the string `omolle.com/fnd/server` with `github.com/author/project`.
